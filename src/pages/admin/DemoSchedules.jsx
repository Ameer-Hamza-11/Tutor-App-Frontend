...
import { User, Calendar, Clock, Briefcase, Eye } from "lucide-react";
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                      demo.DemoStatusDescription === "Scheduled" ? "bg-green-500 text-white" : "bg-yellow-400 text-black"
                    }`}>
            ...
            >
              <div className="space-y-2">
                ...
                <p className="text-sm flex items-center gap-2">
                  <Briefcase className="w-4 h-4 text-indigo-500" /> {demo.JobTitle}
                </p>
                <p className="text-sm flex items-center gap-2">
